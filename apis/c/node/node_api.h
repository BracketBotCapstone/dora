...
void read_dora_input_data_u8(void *dora_event, uint8_t **out_ptr,
                              size_t *out_len);
void read_dora_input_data_i32(void *dora_event, int **out_ptr,
                              size_t *out_len);
void read_dora_input_data_f32(void *dora_event, float **out_ptr,
                              size_t *out_len);
void read_dora_input_data_d64(void *dora_event, double **out_ptr,
                              size_t *out_len);
...
int dora_send_output_d64(void *dora_context, char *id_ptr, size_t id_len,
                         double *data_ptr, size_t data_len);
int dora_send_output_u64(void *dora_context, char *id_ptr, size_t id_len,
                         uint64_t *data_ptr, size_t data_len);

#endif // DORA_NODE_API_H